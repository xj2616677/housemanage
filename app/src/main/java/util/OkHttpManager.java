...
//外部调用的方法
    ...
    {
        return getInstance().post_String(url, params);
    }
     ...
     * @param callback
     */
    private void get_Asyn(String url,ResultCallback callback){
        Request request = new Request.Builder().url(url).build();
     ...
     * @throws IOException
     */
    private String post_String(String url,Param...params) throws IOException {
     ...
     * @param params
     */
    private void post_Asyn(String url,ResultCallback callback,Param...params){
        Request request = buildPostRequest(url, params);
        deliveryResult(callback,request);
     ...
     * @param params
     */
    private void post_Asyn(String url,ResultCallback callback,Map<String,String> params){
